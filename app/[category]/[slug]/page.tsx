...
// Komponen Render PortableText untuk konten Sanity
const ptComponents = {
  types: {
    image: ({ value }: any) => {
  ...
  return (
    <main className="post-detail-main">
      ...
      <style dangerouslySetInnerHTML={{ __html: `
        ...
        .bg-fb { background-color: #5d78af; } .bg-x { background-color: #43c0f4; } .bg-wa { background-color: #82c070; } .bg-tg { background-color: #2ca5e0; } .bg-link { background-color: #000; }
