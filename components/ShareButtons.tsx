  ...
  return (
    <div className="share-buttons-container">
      ...
      <div className="share-icons-wrapper">
        ...
        <a href={`https://twitter.com/intent/tweet?url=${shareUrl}&text=${postTitle}`} target="_blank" className="share-icon-box bg-x">
        ...
        <div className="share-icon-box bg-tg">
           <a href={`https://t.me/share/url?url=${shareUrl}`} target="_blank" style={{ display: 'flex' }}>
